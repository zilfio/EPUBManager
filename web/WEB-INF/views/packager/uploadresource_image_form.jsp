...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        $("#imagefile").fileinput({
            ...
            elErrorContainer: "#errorimagefile"
        });
    });
</script>
<div class="row">
...
<form:form action="${pageContext.request.contextPath}${requestScope.action}" method="POST" enctype="multipart/form-data">
    ...
    <div class="well">
        <div class="form-group">
            ...
            <input id="imagefile" name="imagefile" type="file" class="file-loading" data-show-upload="false" accept="image/*" required />
            <div id="errorimagefile" class="help-block"></div>
        </div>
    </div>
    <div class="form-group">
